...
public class ReCommentAdapter extends RecyclerView.Adapter<ReCommentAdapter.ViewHolder> {
    ...
    public List<Food.CommentPerson> comment_person = new ArrayList<>();
    ...
    public ReCommentAdapter(OnItemClickListener onItemClickListener, Context mContext, ReCommentActivity mActivity, List<Food.CommentPerson> mComment_person) {
